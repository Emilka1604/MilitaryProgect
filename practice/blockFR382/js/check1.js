let constructFunction = function () {
    ...
    for (let i = 0; i < coordsSmallLamps.length; i++) {
        this.smallLamps.set(`smallLamp${i}`, new Elem(`smallLamp${i}`, { "0": "img/lamp2.png", "1": "img/lamp1.png" }, "0",
            { "top": `${coordsSmallLamps[i][0]}`, "left": `${coordsSmallLamps[i][1]}`, "max-width": `${coordsSmallLamps[i][2]}` }))
    }
